...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp/' -isystem 'extern' -'extern/codegen' -I'./shared' -I'./extern' -I'./extern/codegen/include' -DID='"templatemod"' -DVERSION='"0.1.0"'
